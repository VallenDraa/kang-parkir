...
<div id="peta-parkiran" class="flex flex-col items-center justify-center w-full gap-4 p-4 overflow-x-auto rounded-xl shadow md:flex-row shadow-slate-200 bg-slate-100">
