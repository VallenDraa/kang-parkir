 <form action="../lib/action/tambah-motor.action.php" id="form-tambah-motor" method="POST" class="flex flex-col gap-3 mt-5">
   ...
   <div class="flex gap-2">
     ...
     <div class="relative flex items-center flex-grow pl-3 mb-2 border rounded-lg shadow shadow-slate-200 border-slate-300">
       <i class="w-5 text-slate-400 fa-solid fa-motorcycle"></i>
     ...
     <!-- lokasi parkir -->
     <select id="token-parkiran" name="token-parkiran" class="h-full p-2 text-lg bg-transparent border rounded-lg shadow text-slate-800 shadow-slate-200 border-slate-300">
   ...
   <div class="flex flex-col gap-5 mb-2">
     <div class="relative flex items-center pl-3 border rounded-lg shadow shadow-slate-200 border-slate-300">
       <i class="w-5 fa-solid fa-user text-slate-400"></i>
