 <form action="../lib/action/edit-user-admin.action.php" id="form-edit-user" method="POST" class="hidden space-y-3">
   ...
   <div class="flex gap-2">
     <div class="relative flex items-center flex-grow pl-3 mb-2 border rounded-lg shadow shadow-slate-200 border-slate-300 dark:border-slate-700 dark:shadow-slate-700">
       ...
       <label class="absolute px-1 text-sm text-blue-500 transition-all scale-90 -translate-x-2 -translate-y-8 dark:text-blue-400 left-4 top-1/2 peer-placeholder-shown:text-slate-500 bg-slate-100 dark:bg-slate-950 peer-focus:-translate-x-2 peer-focus:-translate-y-8 peer-focus:scale-90 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:translate-x-0 peer-placeholder-shown:scale-100" for="username">
         Username
       </label>
     </div>
   </div>
