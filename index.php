    ...
    <div id="content" class="transition-transform duration-300 ease-out">
        ...
        <main class="px-6 mt-8">
            ...
            <form method="GET" class="relative flex items-center mb-3 border border-slate-400 rounded-lg shadow">
                ...
                <label class="px-1 -translate-x-2 scale-90 transition-all absolute left-4 top-1/2 -translate-y-8 text-sm text-blue-500 peer-placeholder-shown:text-slate-500 bg-slate-50 peer-focus:-translate-x-2 peer-focus:-translate-y-8 peer-focus:scale-90 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:translate-x-0 peer-placeholder-shown:scale-100" for="search-data-tabel">
                    Cari Motor
                </label>
